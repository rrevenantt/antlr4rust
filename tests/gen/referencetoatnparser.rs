...
BaseParser<'input, ReferenceToATNParserExt, I, ReferenceToATNParserContextType, dyn ReferenceToATNListener<'input> + 'static>;
...
impl<'input, I: TokenStream<'input, TF=LocalTokenFactory<'input>>> ReferenceToATNParser<'input, I> {
    ...
    pub fn new(input: Box<I>) -> Self {
        ...
        Self {
            ...
            err_handler: Box::new(DefaultErrorStrategy::<'input, ReferenceToATNParserContextType>::new()),
        }
    }
}

/// Trait for monomorphized trait object that corresponds to nodes of parse tree generated by ReferenceToATNParser
pub trait ReferenceToATNParserContext<'input>:
    for<'x> Listenable<'input, dyn ReferenceToATNListener<'input> + 'x>
...
impl<'input, I: TokenStream<'input, TF=LocalTokenFactory<'input>>> Actions<'input, BaseParserType<'input, I>> for ReferenceToATNParserExt {
...
impl<'input, 'a> Listenable<'input, dyn ReferenceToATNListener<'input> + 'a> for AContext<'input> {
