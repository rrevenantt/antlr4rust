...
pub trait CSVParserContext<'input>:
    for<'x> Listenable<'input, dyn CSVListener<'input> + 'x>
...
impl<'input, 'a> Listenable<'input, dyn CSVListener<'input> + 'a> for CsvFileContext<'input> {
...
impl<'input, 'a> Listenable<'input, dyn CSVListener<'input> + 'a> for HdrContext<'input> {
    fn enter(&self, listener: &mut (dyn CSVListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input, 'a> Listenable<'input, dyn CSVListener<'input> + 'a> for RowContext<'input> {
    fn enter(&self, listener: &mut (dyn CSVListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input, 'a> Listenable<'input, dyn CSVListener<'input> + 'a> for FieldContext<'input> {
    fn enter(&self, listener: &mut (dyn CSVListener<'input> + 'a)) {
        listener.enter_every_rule(self);
