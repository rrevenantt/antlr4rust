...
pub type CSVTreeWalker<'input> =
ParseTreeWalker<'input, LocalTokenFactory<'input>, dyn for<'x> CSVListener<'x>>;
...
impl<'input> CustomRuleContext<'input> for CsvFileContextExt<'input> {
    ...
    {
        listener
            .downcast_mut::<Box<dyn for<'x> CSVListener<'x>>>()
...
ParserRuleContext<'input, TF=LocalTokenFactory<'input>> + BorrowMut<CsvFileContextExt<'input>>
{
...
ParserRuleContext<'input, TF=LocalTokenFactory<'input>> + BorrowMut<HdrContextExt<'input>>
{
...
ParserRuleContext<'input, TF=LocalTokenFactory<'input>> + BorrowMut<RowContextExt<'input>>
{
...
ParserRuleContext<'input, TF=LocalTokenFactory<'input>> + BorrowMut<FieldContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token TEXT
    /// Returns `None` if there is no child corresponding to token TEXT
    fn TEXT(&self) -> Option<Rc<TerminalNode<'input, LocalTokenFactory<'input>>>>
        where
            Self: Sized,
    {
    ...
    fn STRING(&self) -> Option<Rc<TerminalNode<'input, LocalTokenFactory<'input>>>>
        where
            Self: Sized,
    {
