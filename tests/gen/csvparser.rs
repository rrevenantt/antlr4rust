...
pub struct CSVParser {
    base: BaseParser<dyn CSVListener, CSVListenerCaller>,
...
impl Deref for CSVParser {
    type Target = BaseParser<dyn CSVListener, CSVListenerCaller>;
...
impl CSVParser {
    pub fn csvFile(&mut self) -> Result<()/*CsvFileContext*/, ANTLRError> {
        let mut _localctx = CsvFileContext::new(self.ctx.take(), self.base.get_state());
...
impl CSVParser {
    pub fn hdr(&mut self) -> Result<()/*HdrContext*/, ANTLRError> {
        let mut _localctx = HdrContext::new(self.ctx.take(), self.base.get_state());
        //let mut _localctx = BaseRuleContext::new(self.ctx.take(), self.base.get_state());
        //self.ctx = Some(_localctx);
        //let mut _localctx = self.ctx.as_deref_mut().unwrap();
...
impl CSVParser {
    pub fn row(&mut self) -> Result<()/*RowContext*/, ANTLRError> {
        let mut _localctx = RowContext::new(self.ctx.take(), self.base.get_state());
        //let mut _localctx = BaseRuleContext::new(self.ctx.take(), self.base.get_state());
        //self.ctx = Some(_localctx);
        //let mut _localctx = self.ctx.as_deref_mut().unwrap();
...
impl CSVParser {
    pub fn field(&mut self) -> Result<()/*FieldContext*/, ANTLRError> {
        let mut _localctx = FieldContext::new(self.ctx.take(), self.base.get_state());
        //let mut _localctx = BaseRuleContext::new(self.ctx.take(), self.base.get_state());
        //self.ctx = Some(_localctx);
        //let mut _localctx = self.ctx.as_deref_mut().unwrap();
