...
pub trait LexerRecog<'a, T>: Recognizer<'a> + Sized + 'static {
    ...
    fn action(_localctx: &(dyn ParserRuleContext<'a, TF=Self::TF> + 'a), _rule_index: isize, _action_index: isize,
              _recog: &mut T,
    ) {}
}
          ...
          TF: TokenFactory<'input>
{
    fn sempred(&mut self, _localctx: &(dyn ParserRuleContext<'input, TF=TF> + 'input), rule_index: isize, action_index: isize) -> bool {
        <T as LexerRecog<'input, Self>>::sempred(_localctx, rule_index, action_index, self)
    }

    fn action(&mut self, _localctx: &(dyn ParserRuleContext<'input, TF=TF> + 'input), rule_index: isize, action_index: isize) {
        <T as LexerRecog<'input, Self>>::action(_localctx, rule_index, action_index, self)
    }
}
