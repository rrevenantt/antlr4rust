...
//! # Antlr4 runtime
//!
//! This is a runtime for [ANTLR4] parser generator.
//! It is required to use parsers and lexers generated by [ANTLR4]
//!
//! More info on usage is available in:
//!  - [ANTLR4] repository
//!  - [README](../README.md)
//!  - individual structs and traits in this documentation
//!
