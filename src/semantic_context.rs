...
impl SemanticContext {
    ...
    pub(crate) fn evaluate<'a, T: Parser<'a>>(&self, parser: &mut T, outer_context: &<T::Node as ParserNodeType<'a>>::Type) -> bool {
        match self {
    ...
    pub(crate) fn eval_precedence<'a, 'b, T: Parser<'b>>(&'a self, parser: &T, outer_context: &<T::Node as ParserNodeType<'b>>::Type) -> Option<Cow<'a, SemanticContext>> {
        match self {
