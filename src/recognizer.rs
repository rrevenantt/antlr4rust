...
pub trait Recognizer<'input>: TokenAware<'input> {
    ...
    fn sempred(&mut self, localctx: &<Self::Node as ParserNodeType<'input>>::Type, rule_index: isize, action_index: isize) -> bool
        where Self: Sized
    { true }
    fn action(&mut self, localctx: &<Self::Node as ParserNodeType<'input>>::Type, rule_index: isize, action_index: isize)
        where Self: Sized
    {}
...
pub trait Actions<'a, P: Recognizer<'a>> {
    fn sempred(_localctx: &<P::Node as ParserNodeType<'a>>::Type, _rule_index: isize, _action_index: isize,
               _recog: &mut P,
    ) -> bool {
        true
    }

    fn action(_localctx: &<P::Node as ParserNodeType<'a>>::Type, _rule_index: isize, _action_index: isize,
              _recog: &mut P,
    ) {}
